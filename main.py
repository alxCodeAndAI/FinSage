    ...
    def get_historical_prices(self, start=None, end=None, interval="1d"):
        try:
            ...
            if data.empty:
                ...
                return None
            data.reset_index(inplace=True)  # Asegurar que las fechas estén como columnas
...
# Lista de tickers
tickers = [
    'BCOLOMBIA.CL', 'BOGOTA.CL', 'CELSIA.CL', 'CEMARGOS.CL', 'CNEC.CL',
    'CONCONCRET.CL', 'CORFICOLCF.CL', 'ECOPETROL.CL', 'GEB.CL', 'GRUPOSURA.CL',
    'ICOLCAP.CL', 'ISA.CL', 'NUTRESA.CL', 'PFAVAL.CL', 'PFBCOLOM.CL',
...
for ticker in tickers:
    stock = Stock(ticker)
    historical_data = stock.get_historical_prices()  # Usa fechas calculadas dinámicamente
